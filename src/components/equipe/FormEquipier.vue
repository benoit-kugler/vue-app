        ...
        <v-card-text class="pt-1 pb-1">
            <v-container grid-list-md fluid class="pa-1">
                <v-layout row>
                    ...
                    <v-flex xs12 sm6 md2>
						<date-field v-model="tmpItem.date_naissance" label="Date de naissance"></date-field>
                    </v-flex>
                    <v-flex xs12 sm6 md3>
                ...
                <template v-if="withDetails">
                    ...
                    <v-layout row>
                        <v-flex xs12 sm6 md2>
                            <v-text-field
                                v-model="tmpItem.securite_sociale"
                                label="Sécurité sociale"
                            ></v-text-field>
                        </v-flex>
                        <v-flex xs12 sm6 md2>
                            <v-text-field
                                v-model="tmpItem.ville_naissance"
                                label="Ville de naissance"
                            ></v-text-field>
                        </v-flex>
                        <v-flex xs12 sm6 md2>
                            <v-select
                                v-model="tmpItem.departement_naissance"
                                :items="EDIT.departement"
